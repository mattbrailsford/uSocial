...
{
    /// <summary>
    /// The Data Editor for the Facebook OAuth authentication data type
    /// </summary>
    public class FacebookOAuthDataEditor : Panel, IDataEditor
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FacebookOAuthDataEditor"/> class.
        /// </summary>
        internal FacebookOAuthDataEditor(IData data, FacebookOAuthOptions options, int dtdId)
        {
            _data = data;
            _options = options;
            _dtdId = dtdId;
        ...
        public void Save()
        {
            ...
            var val = new FacebookOAuthDataValue
            {
                UserId = hdnScreenName.Value,
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            Page.ClientScript.RegisterClientScriptResource(typeof(FacebookOAuthDataEditor), "Our.Umbraco.uSocial.Resources.Scripts.uSocial.js");
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if(!Page.IsPostBack)
            {
                var val = _data.Value.ToString().DeserializeJsonTo<FacebookOAuthDataValue>();
                if(val != null
                    && !string.IsNullOrWhiteSpace(val.UserId)
                    && !string.IsNullOrWhiteSpace(val.OAuthToken))
                {
					hdnScreenName.Value = val.UserId;
                    hdnToken.Value = val.OAuthToken;

					lblScreenName.Text = "@" + val.UserId;
        ...
        protected override void CreateChildControls()
        {
            ...
            lnkForget.Text = Our.Umbraco.uSocial.Web.UI.App_GlobalResources.uSocial.lbl_forget;
            ...
            lnkAuthorize.Text = Our.Umbraco.uSocial.Web.UI.App_GlobalResources.uSocial.lbl_authorize;
        ...
        {
            var opts = new CallbackOptions
            {
                DtdId = _dtdId,
                WrapperId = wrapperId
            };

            return string.Format("javascript:window.open('{0}/plugins/usocial/facebookoauthcallback.aspx?o={1}', 'Authorize', 'scrollbars=no,resizable=yes,menubar=no,width=800,height=600');return false;",
        ...
        {
            return string.Format("javascript:uSocial_ClearValue('{0}');return false;",
                wrapperId);
        }
    }
}
