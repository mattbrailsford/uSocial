...
namespace Our.Umbraco.uSocial.DataType.Twitter
{
    ...
    public class TwitterOAuthDataEditor : Panel, IDataEditor
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            Page.ClientScript.RegisterClientScriptResource(typeof(TwitterOAuthDataEditor), "Our.Umbraco.uSocial.Resources.Scripts.uSocial.js");
        ...
        protected string CreateAuthorizeLink(string wrapperId)
        {
            ...
            return string.Format("javascript:window.open('{0}/plugins/usocial/twitteroauthcallback.aspx?o={1}', 'Authorize', 'scrollbars=no,resizable=yes,menubar=no,width=800,height=600');return false;",
