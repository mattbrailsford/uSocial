...
{
    /// <summary>
    /// The Data Editor for the Instagram OAuth authentication data type
    /// </summary>
    public class InstagramOAuthDataEditor : Panel, IDataEditor
    {
        /// <summary>
        ...
        /// </summary>
        private readonly InstagramOAuthOptions _options;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InstagramOAuthDataEditor"/> class.
        /// </summary>
        internal InstagramOAuthDataEditor(IData data, InstagramOAuthOptions options, int dtdId)
        {
            _data = data;
            _options = options;
            _dtdId = dtdId;
        ...
        public void Save()
        {
            ...
            var val = new InstagramOAuthDataValue
            {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            Page.ClientScript.RegisterClientScriptResource(typeof(InstagramOAuthDataEditor), "Our.Umbraco.uSocial.Resources.Scripts.uSocial.js");
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if(!Page.IsPostBack)
            {
                var val = _data.Value.ToString().DeserializeJsonTo<InstagramOAuthDataValue>();
                if(val != null
        ...
        protected string CreateAuthorizeLink(string wrapperId)
        {
            ...
            return string.Format("javascript:window.open('{0}/plugins/usocial/instagramoauthcallback.aspx?o={1}', 'Authorize', 'scrollbars=no,resizable=yes,menubar=no,width=800,height=600');return false;",
